...
function add_course_url(el) {
    var course = el.value;
    window.history.replaceState(null, null, "?course=" + course);
    window.location.reload();
}

function add_sub_url(el) {
    var course = document.getElementById("course").value;
    var sem = el.value;
    window.history.replaceState(null, null, "?course=" + course + "&sem=" + sem + "&change_sub");
    window.location.reload();
}
